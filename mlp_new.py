...
class MLP(object):
    ...
    def __init__(self, rng, input1, input2, n_in, fea_dim, context_size, n_hidden, n_out, \
        ...
        # of the hidden layer
        self.logRegressionLayer = LogisticRegression(rng = rng, input = self.hiddenLayer.output, n_in  = n_hidden, n_out = n_out, W_values = None, b_values = None)
        ...
        self.params = self.logRegressionLayer.params + self.hiddenLayer.params + self.projectionlayer.params
